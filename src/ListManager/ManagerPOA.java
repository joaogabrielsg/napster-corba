 ...
 implements ListManager.ManagerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("printFilesHasSubString", new java.lang.Integer (7));
    _methods.put ("printList", new java.lang.Integer (8));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // ListManager/Manager/printFilesHasSubString
       {
         String subString = in.read_string ();
         String $result = null;
         $result = this.printFilesHasSubString (subString);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 8:  // ListManager/Manager/printList
       {
         String $result = null;
